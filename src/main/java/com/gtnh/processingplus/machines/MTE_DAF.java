...
/**
 * Dual Atmosphere Furnace — two screwdriver-switched modes:
 * Oxidizing (air, 200–300°C) for CF fiber stabilization and case hardening.
 * Inert (N₂/Ar, 1000–1500°C) for carbonization and coke/charcoal production.
 */
public class MTE_DAF extends MTEExtendedPowerMultiBlockBase<MTE_DAF> implements ISurvivalConstructable {
    ...
    private static final String[] MODE_NAMES = { "Oxidizing (Air)", "Inert (N₂/Ar)" };
    ...
    private int mMode = 0; // 0 = oxidizing, 1 = inert
            ...
            STRUCTURE_DEFINITION = StructureDefinition.<MTE_DAF>builder()
                ...
                .addElement(
                    ...
                    GTStructureChannels.HEATING_COIL
                        .use(activeCoils(ofCoil(MTE_DAF::setCoilLevel, MTE_DAF::getCoilLevel))))
                .build();
        }
    ...
    public RecipeMap<?> getRecipeMap() {
        return mMode == 0 ? GTNHPPRecipeMaps.sDAFOxidizingRecipes : GTNHPPRecipeMaps.sDAFInertRecipes;
    }
    ...
    public void onScrewdriverRightClick(ForgeDirection side, EntityPlayer aPlayer, float aX, float aY, float aZ,
        ...
        GTUtility.sendChatToPlayer(
            aPlayer,
            "Atmosphere Mode: " + EnumChatFormatting.YELLOW + MODE_NAMES[mMode] + EnumChatFormatting.RESET);
    }
        ...
        tt.addMachineType("Dual Atmosphere Furnace, DAF")
            .addInfo(
                EnumChatFormatting.YELLOW + "Screwdriver"
                    ...
                    + " switches between Oxidizing and Inert atmosphere modes.")
            .addInfo(
                EnumChatFormatting.WHITE + "Oxidizing"
                    + EnumChatFormatting.GRAY
                    + ": CF fiber stabilization (200–300°C), case hardening.")
            .addInfo(
                EnumChatFormatting.WHITE + "Inert"
                    + EnumChatFormatting.GRAY
                    + ": Carbonization (1000–1500°C), coke/charcoal production.")
            ...
            .addCasingInfoMin("Dual-Sealed Atmosphere Casing", 10, false)
